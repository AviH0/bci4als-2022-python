...
image_2 = visual.ImageStim(
    win=win,
    name='image_2', 
    image='start_closed_eyes.png', mask=None, anchor='center',
...
questions = data.TrialHandler(nReps=1.0, method='fullRandom', 
    ...
    trialList=data.importConditions('questions_everyone.xlsx'),
...
for thisQuestion in questions:
    ...
    trials = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('all_stim_rand_order.xlsx'),
