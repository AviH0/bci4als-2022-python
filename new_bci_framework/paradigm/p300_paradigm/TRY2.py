...
image_2 = visual.ImageStim(
    win=win,
    name='image_2', 
    image='C:/Users/yarde/Documents/GitHub/BCI4ALS-MI/start_closed_eyes.png', mask=None, anchor='center',
...
sound_1 = sound.Sound('C:/Users/yarde/Documents/GitHub/BCI4ALS-MI/Beep.wav', secs=1.0, stereo=True, hamming=True,
    name='sound_1')
...
image = visual.ImageStim(
    win=win,
    name='image', 
    image='Instructions_image.PNG', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(2, 2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
start_closed_eyesComponents = [image_2]
...
# update component parameters for each repeat
sound_1.setSound('C:/Users/yarde/Documents/GitHub/BCI4ALS-MI/Beep.wav', secs=1.0, hamming=True)
...
for thisQuestion in questions:
    ...
    for thisTrial in trials:
        ...
        target_sound.setSound(sound_target, secs=1, hamming=True)
